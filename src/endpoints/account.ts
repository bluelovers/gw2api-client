...
import CommerceEndpoint, { DeliveryEndpoint, ITransactionsEndpoint1 } from './commerce'
...
export class BankEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class DyesEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class HomeCatsEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class HomeNodesEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class MailcarriersEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class MasteryPointsEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class MaterialsEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class RaidsEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class TitlesEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
...
export class WalletEndpoint extends AbstractEndpoint
{
	constructor(client)
	{
		super(client)
